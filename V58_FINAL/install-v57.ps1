...
Write-Host ""
Write-Host "v57 installed successfully." -ForegroundColor Green
Write-Host "backend\.env.local preserved." -ForegroundColor Cyan
Write-Host "Deploy firestore.rules.txt in Firebase Console." -ForegroundColor Yellow
Write-Host ""
