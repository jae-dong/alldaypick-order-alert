const APP_VERSION='CLEAN v2.0.0';
...
function engineUnresolvedItems(){
  return engineLatestLines().filter(order=>{
    ...
    return (
      ['new','shipping_wait','cancel','return','exchange','inquiry']
        .includes(key) &&
...
if('serviceWorker' in navigator){
  navigator.serviceWorker.getRegistrations()
    ...
    .finally(()=>navigator.serviceWorker.register('./sw.js?v=clean-v2.0.0',{updateViaCache:'none'}))
    .catch(console.warn);
}
